...
class Tree
{
	...
	public:	 	//Required methods
		...
		Node* getNodeHelper(Node* currentNode, string path);					//given a path (category/sub-category/sub-category/..) the method should return the Node if found, false otherwise
		...
		void removeBook(Node* node,string bookTitle);   //remove a book from a given node
